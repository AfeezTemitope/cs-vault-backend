  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: auto; padding: 32px; background: #0f0f0f; color: #f0f0f0; border-radius: 12px;">
        <h2 style="color: #a78bfa; margin-bottom: 4px;">CS-Vault</h2>
        ...
        <div style="background: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 16px; margin: 20px 0;">
          ...
          <p style="margin: 4px 0;"><span style="color: #888;">Password:</span> <strong style="color: #a78bfa;">${password}</strong></p>
        </div>
        <p style="color: #f87171; font-size: 13px;">⚠️ Please change your password after your first login.</p>
        <a href="${process.env.FRONTEND_URL}/login" style="display: inline-block; margin-top: 16px; padding: 12px 24px; background: #a78bfa; color: #000; font-weight: bold; border-radius: 8px; text-decoration: none;">Login to CS-Vault</a>
